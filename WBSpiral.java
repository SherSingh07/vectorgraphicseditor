...
class  WBSpiral extends WBShape {

	int size;
	public WBSpiral (int x, int y, int w, int h, int size, Color col){
		super(x, y, w, h, col, false);
		this.size = size;
	}
	
	WBSpiral(WBSpiral wbs){
	...
	public void draw(Graphics g){
		...
		for(int i=1; i*20<w; i++){
				...
				g2d.drawArc(x+(w/2)-(i*10), y+(w/2)-(i*10), i*20, i*20, 90, 180);
				g2d.drawArc(x+(w/2)-(i*10), y+(w/2)-(i*10), i*20, (i*20)+10, 270, 180);
		}
	}
